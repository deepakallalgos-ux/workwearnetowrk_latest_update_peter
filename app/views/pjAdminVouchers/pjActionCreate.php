...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-10">
                <h2><?php __('vouchers_infobox_add_voucher_title'); ?></h2>
            </div>
        </div><!-- /.row -->

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php __('vouchers_infobox_add_voucher_desc'); ?></p>
    </div><!-- /.col-md-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminVouchers&amp;action=pjActionCreate" method="post" id="frmCreateVoucher" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-remote="<?php __('voucher_code_exist', false, true); ?>" />
                            </div><!-- /.form-group -->
                        </div><!-- /.col-md-3 -->
                         ...
                         <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group group-fa-change" data-currency-sign="<?php echo pjCurrency::getCurrencySign($tpl['option_arr']['o_currency'], false) ?>">
                                    <input type="text" name="discount" id="discount" class="form-control number decimal text-right required" data-msg-number="<?php __('pj_field_number', false, true);?>" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"/>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="clearfix">
                                    <div class="switch onoffswitch-data onoffswitch-fa-change pull-left">
                                        <div class="onoffswitch">
                                            <input type="checkbox" class="onoffswitch-checkbox" name="apply" id="apply" checked>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date"
                                    ...
                                    >
                                    <input type="text" name="f_date" id="f_date" value="<?php echo date($tpl['option_arr']['o_date_format'], time());?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <input type="hidden" id="validate_fixedtime" name="validate_fixedtime" value="" data-msg-validateFixedTime="<?php __('lblValidateTime', false, true);?>" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"/>
                                    </div>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date"
                                         ...
                                         data-date-week-start="<?php echo (int) $tpl['option_arr']['o_week_start'] ?>"
                                    >
                                    <input type="text" name="p_date_from" id="p_date_from" value="<?php echo date($tpl['option_arr']['o_date_format'], time());?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                                    <span class="input-group-addon">
                                        <span class="fa fa-calendar"></span>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date"
                                         ...
                                         data-date-week-start="<?php echo (int) $tpl['option_arr']['o_week_start'] ?>"
                                    >
                                    <input type="text" name="p_date_to" id="p_date_to" value="<?php echo date($tpl['option_arr']['o_date_format'], time() + 86400);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                                    <span class="input-group-addon">
                                        <span class="fa fa-calendar"></span>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <input type="hidden" id="validate_datetime" name="validate_datetime" value="1" data-msg-remote="<?php __('voucher_validate_datetime', false, true);?>" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"/>
                                    </div>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <input type="hidden" id="validate_time" name="validate_time" value="" data-msg-validateTime="<?php __('voucher_validate_time', false, true);?>" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"/>
                                    </div>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col-md-3 -->
