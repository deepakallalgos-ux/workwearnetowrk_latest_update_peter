...
$previewLocale = $controller->getLocaleId();
$previewPagePrefix = isset($tpl['option_arr']['o_page_prefix']) ? $tpl['option_arr']['o_page_prefix'] : '';
$previewBaseParams = array(
	'page_prefix' => $previewPagePrefix,
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-10">
                <h2><?php echo @$titles['AO40']; ?></h2>
            </div>
        </div><!-- /.row -->

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php echo @$bodies['AO40']; ?></p>
    </div><!-- /.col-md-12 -->
</div>
...
<div class="row border-bottom bar-top">
    <div class="col-1of3">
            ...
            <ul class="dropdown-menu">
                <li>
                    ...
                    foreach($theme_arr as $k => $v)
                    {
                        ...
                        ?>
                        <a href="<?php echo pjUtil::getPreviewUrl(array_merge($previewBaseParams, array('theme' => 'theme' . $k)), $previewCompanyId); ?>" class="thumbnail<?php echo $is_used ? ' active' : null;?>" data-theme="<?php echo pjSanitize::html($v);?>" data-index="theme<?php echo $k; ?>">
        ...
        </div><!-- /.btn-group color-theme-group -->
    </div><!-- /.col-1of3 -->
    ...
    <div class="col-1of3 text-right">
        <a href="<?php echo pjUtil::getPreviewUrl($previewBaseParams, $previewCompanyId); ?>" class="btn btn-secondary open-new-window" target="_blank"><i class="fa fa-eye m-r-xs"></i> <?php __('script_preview_your_website') ?></a>
...
<iframe id="iframeEditor" class="iframe-editor" src="<?php echo pjUtil::getPreviewUrl($previewBaseParams, $previewCompanyId); ?>"></iframe>
