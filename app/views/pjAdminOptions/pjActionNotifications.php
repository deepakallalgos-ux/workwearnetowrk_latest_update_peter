	...
	<div class="row">
		...
		<div class="col-lg-3">
			<div class="ibox float-e-margins settings-box">
				...
				<div class="ibox-content">
					<div class="row">
						<div class="scNotifyTokens scBookingTokens">
							<?php __('opt_o_email_body_text'); ?>
						</div>
						<div class="scNotifyTokens scAccountTokens">
							<?php __('opt_o_account_email_body_text'); ?>
						</div>
						<div class="scNotifyTokens scSendToFriendTokens">
							<?php __('opt_o_send_to_friend_email_body_text'); ?>
						</div>
					</div>
				</div>
			</div>
