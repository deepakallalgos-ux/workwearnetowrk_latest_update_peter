		                        	...
		                        	<div class="row">
								        ...
								        <div class="col-md-4 col-sm-6">
				                            <div class="form-group">
												...
												<div class="input-group">
				                                	...
				                                	<input type="text" name="email" id="email" value="<?php echo pjSanitize::html($tpl['arr']['email']);?>" class="form-control email required" placeholder="info@domain.com" data-msg-required="<?php __('fd_field_required', false, true);?>" maxlength="255">
				                                </div>
				                            </div>
				                        </div>
				                        ...
				                        <div class="col-md-4 col-sm-6">
				                            <div class="form-group">
												...
												<div class="input-group">
				                                	...
				                                	<input type="text" name="password" id="password" value="<?php echo pjSanitize::html($tpl['arr']['password']);?>" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>" maxlength="255">
				                                </div>
				                            </div>
				                        </div>
										...
										<div class="col-md-4 col-sm-6">
				                            <div class="form-group">
				                                ...
				                                <input type="text" id="client_name" name="client_name" value="<?php echo pjSanitize::html($tpl['arr']['client_name']);?>" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>" maxlength="255">
				                            </div>
				                        </div><!-- /.col-md-3 -->
				                        ...
				                        <div class="col-md-4 col-sm-6">
				                            <div class="form-group">
												...
												<div class="input-group">
				                                	...
				                                	<input type="text" name="phone" id="phone" value="<?php echo pjSanitize::html($tpl['arr']['phone']);?>" class="form-control digits" placeholder="1234567890" maxlength="255" data-msg-digits="<?php __('front_digits_required');?>" data-msg-minlength="<?php __('front_phone_invalid');?>" data-msg-maxlength="<?php __('front_phone_invalid');?>">
				                                </div>
				                            </div>
				                        </div><!-- /.col-md-3 -->
				                        ...
				                        <div class="col-md-4 col-sm-6">
				                            <div class="form-group">
												...
												<div class="input-group">
				                                	...
				                                	<input type="text" name="url" id="url" value="<?php echo pjSanitize::html($tpl['arr']['url']);?>" class="form-control" maxlength="255" >
				                                </div>
				                            </div>
				                        </div><!-- /.col-md-3 -->
				                    </div><!-- /.row -->
		                    ...
		                    <div role="tabpanel" class="tab-pane" id="address-book">
		                        <div class="panel-body">
		                            ...
		                            <div class="form-group" id="pjScAddressBookList">
		                            	<?php include dirname(__FILE__) . '/pjActionGetAddresses.php'; ?>
		                            </div>
		                            <div class="form-group">
...
myLabel.alert_del_da_title = <?php x__encode('client_da_title'); ?>;
myLabel.alert_del_da_text = <?php x__encode('client_da_body'); ?>;
