...
?>
<div class="row wrapper border-bottom white-bg page-heading sc-order-page-heading">
    <div class="col-sm-12">
...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-lg-12">
    	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOrders&amp;action=pjActionUpdate" method="post" id="frmUpdateOrder" class="sc-order-update">
			<input type="hidden" name="update_form" value="1" />
			<input type="hidden" name="id" value="<?php echo $tpl['arr']['id']; ?>" />
			
			<div class="tabs-container tabs-reservations m-b-lg">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a class="tab-order-details" href="#order-details" aria-controls="order-details" role="tab" data-toggle="tab"><?php __('order_tab_order'); ?></a></li>
                    <li role="presentation"><a class="tab-client-details" href="#client-details" aria-controls="client-details" role="tab" data-toggle="tab"><?php __('order_tab_client'); ?></a></li>
                    <li role="presentation"><a class="tab-shipping-details" href="#shipping-details" aria-controls="shipping-details" role="tab" data-toggle="tab"><?php __('order_tab_shipping'); ?></a></li>
                </ul>
    
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="order-details">
                        <div class="panel-body">
                        	<div class="alert alert-success"><strong><?php echo @$titles['AO10']; ?></strong> <?php echo @$bodies['AO10'];?></div>
                        	<div class="adm-card">
                        		<h4 class="adm-card__heading">
                        			<i class="fa fa-shopping-cart"></i>
                        			<?php __('order_tab_order'); ?>
                        		</h4>
                        	<div class="row">
                        		<div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label"><?php __('order_uuid'); ?></label>
                        		...
                        		<div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label"><?php __('order_created'); ?></label>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <p class="form-control-static"><a href="javascript:void(0);" id="btnEmailConfirmation" data-id="<?php echo $tpl['arr']['id'];?>" class="btn btn-primary btn-md btn-block btn-outline"><i class="fa fa-bell-o"></i> <?php __('order_send_confirm'); ?></a></p>
                                    </div>
                                </div><!-- /.col-md-3 -->
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <p class="form-control-static"><a href="javascript:void(0);" id="btnEmailPayment" data-id="<?php echo $tpl['arr']['id'];?>" class="btn btn-primary btn-md btn-block btn-outline"><i class="fa fa-bell-o"></i> <?php __('order_send_payment'); ?></a></p>
                                    </div>
                                </div><!-- /.col-md-3 -->
                        	</div>
                        	<div class="adm-card__divider"></div>
                            <div class="row">                                
    							...
    							<div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label"><?php __('order_voucher'); ?></label>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                	<div class="form-group">
                                        <label class="control-label"><?php __('order_shipping_location'); ?></label>
    						...
    						<div class="adm-card">
    							<h4 class="adm-card__heading">
    								...
    								<?php __('order_price'); ?> / <?php __('order_notes'); ?>
    							</h4>
    						<div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="row">
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_price'); ?></label>
                                    	...
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_discount'); ?></label>
                                    ...
                                    <div class="row">
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_insurance'); ?></label>
                                    	...
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_shipping'); ?></label>
                                    ...
                                    <div class="row">
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_tax'); ?></label>
                                    	...
                                    	<div class="col-sm-6 col-xs-12">
                                    		<div class="form-group">
		                                        <label class="control-label"><?php __('order_total'); ?></label>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label"><?php __('order_notes'); ?></label>
    						...
    						<div class="m-b-md">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary btn-outline m-t-xs order-calc"><?php __('btnRecalcualteThePrice');?></a>
                            </div>
                            <div class="hr-line-dashed"></div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="client-details">
                        <div class="panel-body">
                        	<div class="alert alert-success"><strong><?php echo @$titles['AO11']; ?></strong> <?php echo @$bodies['AO11'];?></div>
                            <h3><?php __('order_customer'); ?></h3>
                            <div class="form-group">
                    ...
                    <div role="tabpanel" class="tab-pane" id="shipping-details">
						<div class="panel-body">
							<div class="alert alert-success"><strong><?php echo @$titles['AO12']; ?></strong> <?php echo @$bodies['AO12'];?></div>
								...
								<div class="row form-group">
									...
									{ 
										...
										<div class="col-sm-5 col-xs-12">
											<label><?php __('order_address'); ?>:</label>
										...
										<div class="col-sm-7 col-xs-12">
											...
											<input type="button" value="<?php __('order_copy_b'); ?>" class="btn btn-primary btn-outline btnCopy btnCopyBilling"<?php echo $disabled; ?> />
											<input type="button" value="<?php __('order_copy_s'); ?>" class="btn btn-primary btn-outline btnCopy btnCopyShipping"<?php echo $disabled; ?> />
										</div>
										<?php
									}else{
							...
							<div class="hr-line-dashed"></div> 
							<h3><?php __('order_billing_details'); ?></h3>
							<div class="row">
								<div class="col-md-4 col-sm-6 form-group">
									<label><?php __('order_country'); ?>:</label>
							...
							?>
							<div class="form-group">
                                <label class="control-label"><?php __('order_same') ?></label>
                                <div class="clearfix">
  	...
  	<div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
		      <div class="modal-header">
		        	...
		        	<h4 class="modal-title"><?php __('order_stock_add_title');?></h4>
		      </div>
...
<div class="modal fade" id="stockEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  	<div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
		      <div class="modal-header">
		        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        	<h4 class="modal-title"><?php __('order_stock_edit_title');?></h4>
		      </div>
...
<div class="modal fade" id="confirmEmailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  	<div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
		      <div class="modal-header">
		        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        	<h4 class="modal-title"><?php __('order_confirmation_email_title');?></h4>
		      </div>
...
<div class="modal fade" id="paymentEmailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  	<div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
		      <div class="modal-header">
		        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        	<h4 class="modal-title"><?php __('order_payment_email_title');?></h4>
		      </div>
...
myLabel.product_choose = "-- <?php __('order_p_name'); ?> --";
...
myLabel.alert_del_stock_title = <?php x__encode('order_stock_delete_title'); ?>;
myLabel.alert_del_stock_text = <?php x__encode('order_stock_delete_desc'); ?>;
