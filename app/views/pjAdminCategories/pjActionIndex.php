        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
            	<?php if ($tpl['has_create']) { ?>
	                <div class="row">
	                	<div class="col-md-12">
	                    	<a href="#" class="btn btn-primary pjScAddCategory"><i class="fa fa-plus"></i> <?php __('btnAddCategory') ?></a>
	                    </div><!-- /.col-md-6 -->
	                </div><!-- /.row -->
                <?php } ?>
                <div id="grid"></div>
...
var myLabel = myLabel || {};
myLabel.category_name = <?php x__encode('category_name'); ?>;
myLabel.products = <?php x__encode('category_products'); ?>;
