<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-10">
                <h2><?php __('infoQuotesTitle');?></h2>
            </div>
        </div><!-- /.row -->

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php __('infoQuotesDesc');?></p>
    </div><!-- /.col-md-12 -->
</div>
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-lg-12">
    	...
    	if (!empty($error_code))
    	{
    	    ...
    	    switch (true)
    	    {
    	        case in_array($error_code, array('AOQ01', 'AOQ03', 'AOQ05')):
    	            ?>
    				...
    				<?php
    				break;
                case in_array($error_code, array('AOQ02', 'AOQ04', 'AOQ08')):
    				?>
    	...
    	$statuses = __('quote_statuses', true, false);
    	?>
								...
								<div class="panel-body">
									<form action="" method="get" class="frm-filter-advanced">
										<div class="row">
											...
											<div class="col-md-3 col-md-4 col-sm-6">
												<div class="form-group">
													<label class="control-label"><?php __('quote_products'); ?></label>
											...
											<div class="col-md-3 col-md-4 col-sm-6">
												<div class="form-group">
													...
													<select name="status" id="status" class="form-control">
														<option value="">-- <?php __('lblChoose'); ?> --</option>
														<?php
														foreach (__('quote_statuses', true) as $k => $v)
														{
										...
										<div class="row">
											<div class="col-sm-6">
												<h3 class="m-b-md"><?php __('quote_created'); ?></h3>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
											...
											<div class="col-sm-6">
												<h3 class="m-b-md"><?php __('quote_total'); ?></h3>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label class="control-label"><?php __('lblFrom'); ?></label>
...
?>
var myLabel = myLabel || {};
myLabel.uuid = <?php x__encode('quote_uuid'); ?>;
myLabel.client = <?php x__encode('quote_client'); ?>;
myLabel.created = <?php x__encode('quote_created'); ?>;
myLabel.status = <?php x__encode('quote_status'); ?>;
myLabel.total = <?php x__encode('quote_total'); ?>;
