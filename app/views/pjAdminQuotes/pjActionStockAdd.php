<form action="" method="post">
	...
	<input type="hidden" name="quote_id" value="<?php echo $controller->_get->toInt('quote_id'); ?>" />
	<div class="row form-group">
		<label class="col-md-4 col-sm-5 col-xs-12 control-label"><?php __('quote_select_product'); ?></label>
		<div class="col-md-8 col-sm-7 col-xs-12">
			<select name="product_id" class="form-control stock-product">
				<option value="">-- <?php __('quote_p_name'); ?> --</option>
				<?php
