...
?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBrands&amp;action=pjActionUpdate" method="post" id="frmUpdateBrand">
	<input type="hidden" name="brand_update" value="1" />
	<input type="hidden" name="id" value="<?php echo $tpl['arr']['id']; ?>" />
	<div class="panel-heading bg-completed">
		<p class="lead m-n"><?php __('infoUpdateBrandTitle'); ?></p>
	</div><!-- /.panel-heading -->
