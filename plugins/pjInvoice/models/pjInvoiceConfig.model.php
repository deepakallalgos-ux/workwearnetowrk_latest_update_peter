...
class pjInvoiceConfigModel extends pjInvoiceAppModel
{
	...
	protected $schema = array(
		...
		array('name' => 'invoice_number_digits', 'type' => 'tinyint', 'default' => 5),
		array('name' => 'invoice_number_reset_yearly', 'type' => 'tinyint', 'default' => 0),

		array('name' => 'y_logo', 'type' => 'varchar', 'default' => ':NULL'),
		array('name' => 'y_email_logo', 'type' => 'varchar', 'default' => ':NULL'),
		...
		array('name' => 'y_vat_number', 'type' => 'varchar', 'default' => ':NULL'),
		array('name' => 'y_coc_number', 'type' => 'varchar', 'default' => ':NULL'),
		array('name' => 'y_bank_iban', 'type' => 'varchar', 'default' => ':NULL'),
		...
		array('name' => 'p_accept_mollie', 'type' => 'tinyint', 'default' => 0),
	...
	protected $i18n = array('y_company', 'y_name', 'y_street_address', 'y_city', 'y_state', 'y_template', 'p_paypal_address', 'p_mollie_address', 'p_bank_account');
