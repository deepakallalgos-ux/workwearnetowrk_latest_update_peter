		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var $grid = $("#grid").datagrid({
				...
				columns: [{text: myLabel.country_name, type: "text", sortable: true, editable: true, editableWidth: 300},
				          ...
				          {text: myLabel.status, type: "toggle", sortable: true, editable: true, positiveClass: "pj-toggle-on", negativeClass: "pj-toggle-off", positiveLabel: myLabel.active, positiveValue: "T", negativeLabel: myLabel.inactive, negativeValue: "F"}],
