...
INSERT INTO `plugin_base_fields` VALUES (NULL, 'plugin_base_role_arr_ARRAY_1', 'arrays', 'Plugin Base / Super Admin', 'plugin', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Super Admin', 'plugin');
...
INSERT INTO `plugin_base_fields` VALUES (NULL, 'plugin_base_role_arr_ARRAY_3', 'arrays', 'Plugin Base / Administrator', 'plugin', NULL);
SET @id := (SELECT LAST_INSERT_ID());
