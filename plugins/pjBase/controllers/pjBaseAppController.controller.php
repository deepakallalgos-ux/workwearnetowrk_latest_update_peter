...
class pjBaseAppController extends pjController
{
    ...
    public function beforeFilter()
    {
        ...
        if (!$this->isInstaller())
        {
            ...
            if($is_ip_blocked == true && !in_array($this->_get->toString('controller'), array('pjFront', 'pjFrontEnd', 'pjFrontPublic')))
            {
                $this->sendForbidden();
                return false;
            }
    ...
    public function afterFilter()
    {
        if (!$this->isInstaller())
        {
            ...
            if (
                ...
                $this->appendCss('admin-ui-global.css', PJ_CSS_PATH);
                $this->appendCss('admin-modals-popups.css', PJ_CSS_PATH);
            }
        }
    }
